...
- `statusSchema`：根据故事资料生成的人物状态字段名数组，不照抄固定模板。发挥判断力，为本故事设计若干个会变化、会影响剧情判断的字段，数量由故事决定。必须包含 `性别`、`身份`、`外貌`、`性格`、`姿势`；其他字段按题材选择，例如职业、阵营、能力、资源、危险源、关系债、当前位置、随身物。
...
```json
{
  ...
  "openingText": "",
  "worldview": "",
  "statusSchema": ["性别", "身份", "外貌", "性格", "姿势", "故事专属字段", "..."],
