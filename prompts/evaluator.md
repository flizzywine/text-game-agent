...
2. 优先发现会破坏游玩体验的问题：剧情停滞、机械顺从玩家、人物失去独立性、空间/物理不可行、跨轮重复、状态栏不更新、线索不回收、玩家选项同质化。
